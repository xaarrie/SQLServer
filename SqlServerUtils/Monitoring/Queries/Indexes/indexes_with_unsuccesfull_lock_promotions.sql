...
i.name as IndexName,
s.index_lock_promotion_attempt_count - s.index_lock_promotion_count as [Unsuccessfull lock promotions]
...
where (s.index_lock_promotion_attempt_count - s.index_lock_promotion_count) > 0 and o.is_ms_shipped = 0
